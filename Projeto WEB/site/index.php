...
<body>
    <div id="caixa">
        ...
        <div id="caixa_slider">
            <div class=" slidebanner slider center">
        ...
        <div id="caixa_conteudo">
            <div id="conteudo" class="center">
                ...
                <div class="caixa_menu_nav">

                    <div class="menu_nav"> <a href="curiosidades.php"> PRODUTO DO MÊS </a> </div>
                    <div class="menu_nav"> Item 02 </div>
                    <div class="menu_nav"> Item 03 </div>
                ...
                <div id="caixa_galeria">
                    ...
                    <div id="galeria">
                        ...
                        <aside class="produtos">
                            <div class="fotoProdutos produtoSt"> 
                                <img class="imgFoto background" src="bd/arquivos/<?=$rs['imagem']?>"> </div>
                            <div class="infoProduto">
                                <div class="nomeProduto"> Nome : <?=($rs['nome']); ?> </div>
                                <div class="descProduto"> Descrição : <?=($rs['descrição']); ?> </div>
                                <div class="precoProduto"> Preço : R$<?=($rs['preco']); ?></div>
