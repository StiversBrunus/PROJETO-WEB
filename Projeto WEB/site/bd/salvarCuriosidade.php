                    ...
                    if(in_array($tipoArquivo, $arquivosPermitidos))
                    {
                        ...
                        if($tamanhoArquivo <= $tamanhoPermitido){
                            ...
                            if(move_uploaded_file($arquivoTemporario, $diretorio.$nomeFoto)){
                                ...
                                //echo("$nomeFoto");
                                $sql = "INSERT INTO tbl_curiosidade (titulo, texto, imagem) values('".$titulo."', '".$texto."',
                                                    '".$nomeFoto."')";
                        ...
                        if(in_array($tipoArquivo, $arquivosPermitidos))
                        {
                            ...
                            if($tamanhoArquivo <= $tamanhoPermitido){
                                ...
                                if(move_uploaded_file($arquivoTemporario, $diretorio.$nomeFoto)){
                                    ...
                                    //echo("Arquivo Transferido");
                                    //echo("$nomeFoto");
                                    $sql = " UPDATE tbl_curiosidade SET titulo = '".$titulo."', texto = '".$texto."', imagem = '".$nomeFoto."' WHERE codigo=".$_SESSION['id'];
                                    //echo("$sql");
