...
CREATE TABLE `nivel_acesso` (
  ...
  `adm_faleConosco` tinyint(4) NOT NULL,
  `adm_usuario` tinyint(4) NOT NULL,
...
INSERT INTO `nivel_acesso` VALUES (18,'Administrador',1,1,1,NULL),(25,'Nivel para exclusão',1,0,1,NULL),(26,'teste para exclusao',1,1,1,NULL),(31,'Supervisor',1,1,1,NULL);
